...
import com.ads.narayan.nativeadsutils.isOnline
import com.ads.narayan.nativeadsutils.is_need_to_load_multiple_native_ad_request
import com.ads.narayan.nativeadsutils.list_of_admob_native_ads
...
//            } else if (!isAppNotPurchased || !is_enable_native_ad_from_remote_config) {
    ...
    fun loadAd(
        ...
        logE(tag = TAG, message = "loadAd: View before Added == "+ list_of_admob_native_ads.size)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            logE(tag = TAG, message = "loadAd: View after Added == "+ listOfNativeAdView.size)
