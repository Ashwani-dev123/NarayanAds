...
import com.ads.narayan.databinding.LayoutNativeAdMainBinding
import com.ads.narayan.databinding.PlaceholderShimmerBinding
import com.ads.narayan.databinding.PlaceholderTextBinding
import com.ads.narayan.nativeadsutils.blurEffect.BlurImage
import com.google.android.gms.ads.nativead.NativeAdOptions
import com.ads.narayan.nativeadsutils.PlaceHolderType
import com.ads.narayan.nativeadsutils.addMargin
import com.ads.narayan.nativeadsutils.beVisibleIf
import com.ads.narayan.nativeadsutils.getColorRes
import com.ads.narayan.nativeadsutils.getColorStateRes
import com.ads.narayan.nativeadsutils.gone
import com.ads.narayan.nativeadsutils.inflateLayout
import com.ads.narayan.nativeadsutils.inflater
import com.ads.narayan.nativeadsutils.invisible
import com.ads.narayan.nativeadsutils.isInternetAvailable
import com.ads.narayan.nativeadsutils.logE
import com.ads.narayan.nativeadsutils.logI
import com.ads.narayan.nativeadsutils.removeMargin
import com.ads.narayan.nativeadsutils.setColorAlpha
import com.ads.narayan.nativeadsutils.toCamelCase
import com.ads.narayan.nativeadsutils.visible
...
//                        NativeAdInterstitialType.FULL_SCREEN -> mCurrentView.inflateLayout(R.layout.layout_google_full_screen_native_ad)
    ...
    @RequiresApi(Build.VERSION_CODES.M)
    public fun loadAd() {
        Log.e(TAG, "loadAd: nativeadload")
        Log.e(TAG, "loadAd: nativeadload"+mCurrentView.isVisible)
