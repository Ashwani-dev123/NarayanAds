package com.ads.narayan.exitdialog
...
import com.ads.narayan.databinding.DialogExitBinding
import com.ads.narayan.nativeadsutils.beVisibleIf
import com.ads.narayan.nativeadsutils.exitTheApp
import com.ads.narayan.nativeadsutils.getColorRes
import com.ads.narayan.nativeadsutils.getLocalizedString
import com.ads.narayan.nativeadsutils.is_exit_dialog_opened
import com.ads.narayan.nativeadsutils.setIncludeFontPaddingFlag
...
class ExitDialog(
    ...
    fun show(
        ...
        if (!fActivity.isFinishing && !isShowing) {
            ...
            mBinding.nativeAdView.beVisibleIf(true)
    ...
    private fun testExitDialogUI() {
        if (isForTesting) {
            ...
            Log.e(TAG, "testExitDialogUI: "+isTestNeedToShowAds)
